...
//一个内存文件映射不够用，则用多个
public class MappedFileReader2 {
    ...
    public MappedFileReader2(String fileName, int arraySize) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
    	MappedFileReader2 reader = new MappedFileReader2("D:\\test\\a.txt", 1);
